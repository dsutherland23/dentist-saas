...
import { ArrowLeft, Loader2, Eye, Calendar, User } from "lucide-react"
...
export default function ReceivedReferralsPage() {
    ...
    const fetchReferrals = React.useCallback(() => {
        setLoading(true)
        fetch("/api/referrals?type=received")
            .then((res) => res.json())
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    >
                        ...
                        Back to Clinical Referrals
                    </Button>
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">Received Referrals</h1>
                            <p className="text-lg text-slate-600 mt-2">Manage referrals sent to your practice</p>
                        </div>
                        <Badge variant="outline" className="px-4 py-1 text-sm bg-white shadow-sm border-slate-200">
                ...
                {loading ? (
                    ...
                    <Card className="p-16 text-center bg-white rounded-3xl border-slate-100 shadow-sm">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-2">No referrals yet</h3>
                        <p className="text-slate-500 max-w-sm mx-auto">When other dentists refer patients to you, they will appear here for your review.</p>
                    </Card>
                ) : (
